...
abstract class StaffMember {
    ...
    public StaffMember(double baseSalary, double bonusRate) {
        ...
        this.baseSalary = baseSalary; this.bonusRate = bonusRate;
    }
...
class TeamLead extends StaffMember implements Auditable {
    ...
    public TeamLead(double baseSalary, double bonusRate, int teamSize) {
        super(baseSalary, bonusRate); this.teamSize = teamSize;
    }
    @Override public double calculateBonus() { return getSalary() * bonusRate; }
    @Override public String auditRecord() {
